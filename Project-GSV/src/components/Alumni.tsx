   ...
   return(
     <main className="alumni">
       ...
       <div className="alumni__intro">
         ...
         <p className="description">For the past 20 years, our school has been a place where dreams are nurtured and lifelong values are instilled. Our alumni continue to shine as ambassadors of our institution, making remarkable contributions in their fields and communities. This page celebrates their stories and achievements.</p>
       </div>

       <div className="alumni__testimonies">
       <h3 className="heading">Voices of Our Alumni</h3>
         <p className="description">Our alumni reflect on their journeys, sharing the lessons, friendships, and experiences that shaped their paths. Their stories are a testament to the power of education, community, and lifelong learning.</p>
         <Testimony />
       </div>

       <div className="alumni__gallery">
         <h3 className="heading">Celebrating Alumni Connections</h3>
         <p className="description">Our alumni remain an integral part of our school community, always connected by the shared memories of their time here. From reunions to professional milestones, these images capture moments of joy, celebration, and continued growth. Scroll through to see snapshots of our alumni gatherings and the enduring bonds that define our school family.</p>
        <AlumniSlider />
       </div>
       ...
       <div className="alumni__form">
         ...
         <p className="description">Whether you're reconnecting with old friends or looking to share your journey with current students, our alumni network is a growing community that welcomes all. Stay in touch, contribute to future events, and help inspire the next generation of students by joining our alumni platform. Your journey with us never truly ends!</p>

       <div className="form-container">
    <h3>Register as an Alumni</h3>
         <p className="form-caption">Join the legacy and stay connected with your alma mater.</p>
    <form>
        {/* <!-- Name Field --> */}
